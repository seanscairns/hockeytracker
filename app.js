...
// NOTE: We intentionally do NOT use a global `touchend -> preventDefault()` handler.
// That pattern can break rapid tapping (common for scorekeeping) by suppressing
// the synthetic click event on iOS Safari.
//
// Double-tap zoom is handled via the viewport meta tag (user-scalable=no)
// and CSS `touch-action: manipulation;` in index.html.
